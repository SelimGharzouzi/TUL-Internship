 ...
 * @param compression_size   Pointer to store compressed data size
 */
 ...
 *        Splits the input buffer into two segments and compresses them in parallel.
 *
 * @param input                Pointer to input data buffer.
 * @param input_size           Size of the input buffer.
 * @param output1              Pointer to first output buffer.
 * @param compression_size1    Pointer to store compressed size of first segment.
 * @param output2              Pointer to second output buffer.
 * @param compression_size2    Pointer to store compressed size of second segment.
 */
